...
Silver::Silver(float positionX, float positionY, IntRect arena, Vector2f resolution, int tileSize)
{
...
void Silver::isPlayerInRange(Vector2f playerPosition)
{
...
void Silver::update(float elapsedTime, Vector2f playerPosition)
{
	if (m_isSpawned) {

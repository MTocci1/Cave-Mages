...
Bronze::Bronze(float positionX, float positionY, IntRect arena, Vector2f resolution, int tileSize)
{
...
void Bronze::isPlayerInRange(Vector2f playerPosition)
{
...
void Bronze::update(float elapsedTime, Vector2f playerPosition)
{
	if (m_isSpawned) {
